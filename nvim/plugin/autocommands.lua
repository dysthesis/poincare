...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(ev)
    ...
    keymap.set('n', 'gD', fzf.lsp_declarations, desc('[G]o to [D]eclaration'))
    keymap.set('n', 'gd', fzf.lsp_definitions, desc('[G]o to [D]efinition'))
    keymap.set('n', '<space>gt', fzf.lsp_typedefs, desc('[G]o to [T]ype definition'))
    keymap.set('n', '<space>ca', fzf.lsp_code_actions, desc('[C]ode [A]ctions'))
    ...
    keymap.set('n', 'gi', fzf.lsp_implementations, desc('[G]et [I]mplementation'))
    ...
    keymap.set('n', '<space>wa', vim.lsp.buf.add_workspace_folder, desc('[W]orkspace folder [A]dd'))
    keymap.set('n', '<space>wr', vim.lsp.buf.remove_workspace_folder, desc('[W]orkspace folder [R]emove'))
    ...
    keymap.set('n', '<leader>lr', vim.lsp.codelens.run, desc('Code [L]ens [R]un'))
    keymap.set('n', '<space>lR', vim.lsp.codelens.refresh, desc('Code [L]ens [R]efresh'))
    keymap.set('n', 'gr', vim.lsp.buf.references, desc('[G]et [R]eferences'))
